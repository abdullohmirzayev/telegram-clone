...
interface Props {
	onSentMessage: (values: z.infer<typeof messageSchema>) => void
	messageForm: UseFormReturn<z.infer<typeof messageSchema>>
}

const Chat: FC<Props> = ({ onSentMessage, messageForm }) => {
	...
	return (
		<div className='flex flex-col justify-end z-40 min-h-[92vh]'>
			...
			{/* <div className='w-full h-[88vh] flex items-center justify-center'>
				<div className='text-[100px] cursor-pointer' onClick={() => onSentMessage({text: '😊'})}>😊</div>
			 </div> */}

			{/* Message input */}
			<Form {...messageForm}>
				<form
					onSubmit={messageForm.handleSubmit(onSentMessage)}
